  ...
  <div class="account-box">
    <div class="toggle">
      ...
      <a @click="isMsgLogin=true" href="javascript:;" v-else>
        <i class="iconfont icon-iconmsg"></i> 使用短信登录
      </a>
    </div>
      ...
      <template v-if="!isMsgLogin">
        ...
        <div class="form-item">
          ...
          <div class="error" v-if="errors.account">
            <i class="iconfont icon-icon-Warning" />
            {{errors.account}}
          </div>
        </div>
        <!-- 密码 -->
        <div class="form-item">
          ...
          <div class="input">
            <i class="iconfont icon-icon_user"></i>
            <Field :class="{error:errors.password}" v-model="form.password"  name="password" type="text" placeholder="请输入密码" />
          </div>
          <!-- 错误提示 -->
...
export default {
  ...
  setup () {
    ...
    const login = async () => {
      ...
      // console.log(valid) 结果为 true 时表示点击登录验证通过
      if (valid) {
        try {
          let data = null
          // console.log(isMsgLogin.value) 结果为 true 短信验证码登录 false 账号密码登录
          if (isMsgLogin.value) {
            // 短信验证码登录
